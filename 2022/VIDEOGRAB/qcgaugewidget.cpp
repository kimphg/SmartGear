...
void QcGaugeWidget::initFigure()
{
    ...
    bkg1->clearrColors();
    bkg1->addColor(0.1,QColor(32,64,128));
    bkg1->addColor(1.0,QColor(16,32,64));

    QcBackgroundItem *bkg2 = this->addBackground(88);
    bkg2->clearrColors();
    bkg2->addColor(0.1,QColor(16,100,150));
    bkg2->addColor(1.0,QColor(16,100,150));

    this->addArc(55)->setColor(Qt::white);
    QcDegreesItem *item = this->addDegrees(65);
    item->setValueRange(minAngle,maxAngle);
    item->setStep(30);
    item->setColor(Qt::white);

//    this->addColorBand(50);

    QcValuesItem *vlitem = this->addValues(75);
