...
QT_MOC_LITERAL(4, 39, 15), // "modbusInputRead"
QT_MOC_LITERAL(5, 55, 10), // "timerEvent"
QT_MOC_LITERAL(6, 66, 12), // "QTimerEvent*"
QT_MOC_LITERAL(7, 79, 5) // "event"

    },
    "c_gimbal_control\0onStateChanged\0\0state\0"
    "modbusInputRead\0timerEvent\0QTimerEvent*\0"
    "event"
};
...
void c_gimbal_control::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        c_gimbal_control *_t = static_cast<c_gimbal_control *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onStateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->modbusInputRead(); break;
...
const QMetaObject c_gimbal_control::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_c_gimbal_control.data,
      qt_meta_data_c_gimbal_control,  qt_static_metacall, nullptr, nullptr}
};
