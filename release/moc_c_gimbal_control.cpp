...
const QMetaObject c_gimbal_control::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_c_gimbal_control.data,
      qt_meta_data_c_gimbal_control,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *c_gimbal_control::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_c_gimbal_control.stringdata0))
        return static_cast<void*>(const_cast< c_gimbal_control*>(this));
