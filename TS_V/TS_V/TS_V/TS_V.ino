...
bool processPelco(){
	...
	{
		float ph = ((((unsigned char)pelco_input_buff[2]) << 8) + (unsigned char)pelco_input_buff[3]) / 65535.0*10000.0 - 5000.0;
		float pv = ((((unsigned char)pelco_input_buff[4]) << 8) + (unsigned char)pelco_input_buff[5]) / 65535.0*10000.0 - 5000.0;
